        ...
        <div data-v-67ef3a4a class="layout clear">
            ...
            <div data-v-67ef3a4a="" class="right phone">
                <div data-v-67ef3a4a="" class="typeTab">
                    <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/index.jsp" style="color: rgb(199, 0, 11);">中文</a>&nbsp;/&nbsp;
                    <a data-v-67ef3a4a="" href="../en/index.html">English</a>
                </div>
                <div data-v-67ef3a4a="" class="menu">
                    <a data-v-67ef3a4a="" href="mymain.html">我的车速递</a>
                </div>
                <div data-v-67ef3a4a="">
            ...
            <div class="recomendCon clear">
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                    <ul class="layui-tab-title" style="font-size: 20px;">
                        <li class="layui-this" style="font-size: 20px; color: #000;"><a href="${pageContext.request.contextPath}/shortRent/shortRentList">短租自驾</a></li>
