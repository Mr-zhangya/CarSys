    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30=""
                    ...
                    data-v-95ac8d30="" href="${pageContext.request.contextPath}/user/exit">帮助中心</a>|<a data-v-95ac8d30=""
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "get",
            url: "${pageContext.request.contextPath}/car/findcar" + getid,
            dataType: "json",
            success: function (car) {
                if (car != null) {
                    vm.infos = car;
                } else {
                    $("#RentCar").text("您的订单出错了");
                }
            },
            error: function () {
                alert("ajax加载失败");
