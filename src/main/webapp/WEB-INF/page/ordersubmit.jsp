...
<head>
    ...
    <link rel="stylesheet" href="../../resources/css/order.ordersubmit.css">
    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30=""
                                                                 href="../mymain/mymain.html">我的订单</a>|<a
                    data-v-95ac8d30="" href="helpCenter.html">帮助中心</a>|<a data-v-95ac8d30=""
                                                                          href="javascript:void">退出</a></div>
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "get",
            url: "/carsys/car/findcar.do" + getid,
            dataType: "json",
            success: function (data) {
                if (data.code == 1) {
                    vm.infos = data.info;
