        ...
        <div data-v-67ef3a4a class="layout clear">
            ...
            <div data-v-67ef3a4a="" class="right phone">
                <div data-v-67ef3a4a="" class="typeTab">
                    <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/user/index" style="color: rgb(199, 0, 11);">中文</a>&nbsp;/&nbsp;
        ...
        <div data-v-39f7f629="" class="layout clear">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/rent/shortRent" target="_self" class="colorRed">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
