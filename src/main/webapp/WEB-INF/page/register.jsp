        ...
        <div data-v-676ecf83="" class="layout">
            <div data-v-676ecf83="" class="registerCom clear">
                <div data-v-676ecf83="" class="registerType left">
                    ...
                    <form id="from" class="layui-form" method="post">
                        <div class="layui-form-item">
                            <i class="layui-icon layui-icon-cellphone" style="font-size: 20px;"></i>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="tel" id="tel" name="tel" placeholder="请输入手机号" class="layui-input"
                                           onblur="validateTel()">
                                </div>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input id="password2" type="password" placeholder="请再次输入密码" class="layui-input"
                                           onblur="validateMm()">
                                </div>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" id="mail" name="email" placeholder="请输入电子邮箱，用于登录和找回密码"
                                           onblur="validateMail()" class="layui-input">
                                </div>
                            </div>
                            <div style="right: auto">
                                <button type="button" class="btn btn-primary" onclick="return sendValidate()">获取验证码</button>
                            </div>
                            <span id="result" style="font-size:18px"></span>
                            <span id="result2" style="font-size:18px"></span>
                        </div>
                        <div class="layui-form-item">
                            <i class="layui-icon layui-icon-vercode" style="font-size: 20px;"></i>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" id="code" name="invitation"
                                           placeholder="请输入验证码" onblur="validateCode()" class="layui-input">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn" type="submit" name="submit" onclick="return validateForm()">
                                    立即提交
                                </button>
                            </div>
                        </div>
    ...
    <div data-v-3aaf9db2="" data-v-676ecf83="" class="footer2">
        <div data-v-3aaf9db2="" class="layout clear">
            <div data-v-3aaf9db2="" class="d1"><a data-v-3aaf9db2="" href="about.html">关于车速递</a>|<a data-v-3aaf9db2=""
                                                                                                    target="_blank"
                                                                                                    href="http://search.51job.com/list/co,c,2264765,0000,10,1.html">诚聘英才</a>|
            ...
            <div data-v-3aaf9db2="" class="d3">
                上海车速递汽车租赁有限公司（总公司）杭州/深圳/广州/成都/武汉/苏州/佛山（分公司）
            </div>
            ...
            <div data-v-3aaf9db2="" class="d5"><a data-v-3aaf9db2=""
                ...
                <img data-v-3aaf9db2="" src="https://www.chesudi.com/static/img/cnnic.4528ccc.png" class="img2"></div>
        </div>
    </div>
