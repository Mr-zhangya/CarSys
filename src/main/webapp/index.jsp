...
<head>
    ...
    <link rel="stylesheet" href="resources/css/pagehome.index.css">
    ...
    <script type="application/javascript" src="resources/layui/layui.js"></script>
    ...
    <div data-v-67ef3a4a class="csdheader">
        <div data-v-67ef3a4a class="layout clear">
            <div data-v-67ef3a4a class="left csdnav">
                <label data-v-67ef3a4a>
                    ...
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/register/" class="colorRed" style="margin-right: 10px;">注册</a>
                </label>
        ...
        <div data-v-67ef3a4a="" class="right phone">
            ...
            <div data-v-67ef3a4a="" class="menu">
                <a data-v-67ef3a4a="" href="WEB-INF/page/login.jsp">我的车速递</a>
            </div>
            <div data-v-67ef3a4a="">
        ...
        <div data-v-39f7f629="" class="layout clear">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/rent/shortRent" target="_self" class="">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
